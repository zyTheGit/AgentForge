...
- [规则正文装配](docs/rules.md)——四层顺序，以及 `custom/` 与 `templates/` 怎么选
- [custom/ 逐字规则](docs/custom-rules.md)——收录规则、什么时候该用它
- [templates/ 模板](docs/templates.md)——登记与查找优先级、三个内置模板、可用变量、引擎约束
